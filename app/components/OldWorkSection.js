  ...
  return (
    <motion.div style={{ backgroundColor }}>
        ...
        <div className="space-y-24 ">
          ...
          >
            <div className="w-full md:w-1/2 lg:w-1/3 lg:mr-16">
              <div className="relative rounded-lg pt-8 overflow-hidden md:overflow-visible h-[75vh] sm:h-[75vh] md:h-screen w-screen md:w-auto ">
                {/* Label */}
            ...
            <div ref={wkContainerRef} className="w-full md:w-1/2 lg:w-1/3 flex flex-col items-center justify-center">
              ...
              <div className="flex flex-col space-y-4">
                <div className="flex justify-center items-center space-x-4">
                  ...
                  <Link href="/wildknot">
                                <GradientButton text='View Case Study'/>
      ...
      <GradientButton text='View Case Study'/>
          ...
          >
            <div className="w-full md:w-1/2 lg:w-1/3 lg:mr-16">
              <div className="relative rounded-lg pt-8 overflow-hidden md:overflow-visible h-[75vh] sm:h-screen md:h-screen w-screen md:w-auto ">
                {/* Label */}
                <div className="absolute top-2 left-2 text-white text-xs font-semibold z-40 py-1 px-2 rounded bg-blue-500">
                  App
                </div>
        ...
        <GradientButton text='View Gallery'/>
