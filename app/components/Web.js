...
import animationData from '../lottie/Web.json'; // Ensure this path is correct
...
const Web = () => {
  ...
  return (
    <div ref={containerRef} className="relative bg-blue-950 w-screen h-[200vh]">
      ...
      <div className="relative z-30 pt-[25vh] h-screen">
