...
import animationData from '../lottie/motion5.json'; // Ensure this path is correct
...
const ScrollControlledLottie = () => {
  ...
  return (
    <div ref={containerRef} className="relative bg-blue-950 w-full h-[300vh]">
      ...
      <div className="relative z-30 pt-[25vh] h-[100vh]">
        <div className="grid grid-cols-3 grid-rows-2 h-full gap-8 p-8">
          <div className="col-span-2 row-span-1 bg-blue-500 flex justify-center items-center rounded-lg">
            <span className="text-white">2x1 Cell</span>
          </div>
          <div className="col-span-1 row-span-2 bg-red-500 flex justify-center items-center rounded-lg">
            <span className="text-white">1x2 Cell</span>
          </div>
